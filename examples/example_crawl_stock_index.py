...
from src.market_data.infrastructure.persistence.postgresql import StockIndexRepository
from src.shared.utils.load_yaml_config import load_config


async def main():
    parser = argparse.ArgumentParser(description="Crawl stock index based on config.")
    parser.add_argument("--url", type=str, help="Path to the configuration YAML file", default="configs/crawl_stock_index.yaml")
    ...
    crawler = CrawlStockIndex(headless=False)
